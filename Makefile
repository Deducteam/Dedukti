...
lib:
	ocamlbuild -Is $(SRC_DIRS) $(MENHIR) $(OPTIONS) dedukti.cmxa

BINARIES=ediloh dkcheck dktop dkdep dkindent
...
.PHONY: ediloh dkcheck dktop dkdep dkindent tests clean doc uninstall
