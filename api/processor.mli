...
module MakeEnv (R:Kernel.Reduction.S) : ENV

module MakeTypeChecker(E:ENV)      : S with type t = unit

module MakeSignatureBuilder(E:ENV) : S with type t = Kernel.Signature.t

module MakeEntryPrinter(E:ENV)     : S with type t = unit

module MakeDependencies(E:ENV)     : S with type t = Dep.t
