...
%token <Kernel.Basic.loc> KW_LOCAL
...
line:
  | id=ID ps=param* COLON ty=term DOT
    {fun md -> Decl(fst id, snd id, Public, Global, Static, scope_term md [] (mk_pi ty ps))}
  | KW_PRV id=ID ps=param* COLON ty=term DOT
    {fun md -> Decl(fst id, snd id, Private, Global, Static, scope_term md [] (mk_pi ty ps))}
  | KW_LOCAL id=ID ps=param* COLON ty=term DOT
    {fun md -> Decl(fst id, snd id, Public, Local, Static, scope_term md [] (mk_pi ty ps))}
  | KW_DEF id=ID COLON ty=term DOT
    {fun md -> Decl(fst id, snd id, Public, Global, Definable, scope_term md [] ty)}
  | KW_PRV KW_DEF id=ID COLON ty=term DOT
    {fun md -> Decl(fst id, snd id, Private, Global, Definable, scope_term md [] ty)}
  | KW_LOCAL KW_DEF id=ID COLON ty=term DOT
    {fun md -> Decl(fst id, snd id, Public, Local, Definable, scope_term md [] ty)}
  | KW_INJ id=ID COLON ty=term DOT
    {fun md -> Decl(fst id, snd id, Public, Global, Definable, scope_term md [] ty)}
  | KW_PRV KW_INJ id=ID COLON ty=term DOT
    {fun md -> Decl(fst id, snd id, Private, Global, Definable, scope_term md [] ty)}
  | KW_DEF id=ID COLON ty=term DEF te=term DOT
    {fun md -> Def(fst id, snd id, Public, Global, false, Some(scope_term md [] ty),
                     scope_term md [] te)}
  | KW_DEF id=ID DEF te=term DOT
    {fun md -> Def(fst id, snd id, Public, Global, false, None, scope_term md [] te)}
  | KW_DEF id=ID ps=param+ COLON ty=term DEF te=term DOT
    {fun md -> Def(fst id, snd id, Public, Global, false, Some(scope_term md [] (mk_pi ty ps)),
                     scope_term md [] (mk_lam te ps))}
  | KW_DEF id=ID ps=param+ DEF te=term DOT
    {fun md -> Def(fst id, snd id, Public, Global, false, None, scope_term md [] (mk_lam te ps))}
  | KW_PRV KW_DEF id=ID COLON ty=term DEF te=term DOT
    {fun md -> Def(fst id, snd id, Private, Global, false, Some(scope_term md [] ty),
                     scope_term md [] te)}
  | KW_PRV KW_DEF id=ID DEF te=term DOT
    {fun md -> Def(fst id, snd id, Private, Global, false, None, scope_term md [] te)}
  | KW_PRV KW_DEF id=ID ps=param+ COLON ty=term DEF te=term DOT
    {fun md -> Def(fst id, snd id, Private, Global, false, Some(scope_term md [] (mk_pi ty ps)),
                     scope_term md [] (mk_lam te ps))}
  | KW_PRV KW_DEF id=ID ps=param+ DEF te=term DOT
    {fun md -> Def(fst id, snd id, Private, Global, false, Some(scope_term md [] (mk_lam te ps)),
                     scope_term md [] te)}
  | KW_LOCAL KW_DEF id=ID COLON ty=term DEF te=term DOT
    {fun md -> Def(fst id, snd id, Public, Local, false, Some(scope_term md [] ty),
                     scope_term md [] te)}
  | KW_LOCAL KW_DEF id=ID DEF te=term DOT
    {fun md -> Def(fst id, snd id, Public, Local, false, None, scope_term md [] te)}
  | KW_LOCAL KW_DEF id=ID ps=param+ COLON ty=term DEF te=term DOT
    {fun md -> Def(fst id, snd id, Public, Local, false, Some(scope_term md [] (mk_pi ty ps)),
                     scope_term md [] (mk_lam te ps))}
  | KW_LOCAL KW_DEF id=ID ps=param+ DEF te=term DOT
    {fun md -> Def(fst id, snd id, Public, Local, false, None, scope_term md [] (mk_lam te ps))}
  | KW_THM id=ID COLON ty=term DEF te=term DOT
    {fun md -> Def(fst id, snd id, Public, Global, true, Some(scope_term md [] ty),
                     scope_term md [] te)}
  | KW_THM id=ID ps=param+ COLON ty=term DEF te=term DOT
    {fun md -> Def(fst id, snd id, Public, Global, true, Some(scope_term md [] (mk_pi ty ps)),
                     scope_term md [] (mk_lam te ps))}
  | KW_LOCAL KW_THM id=ID COLON ty=term DEF te=term DOT
    {fun md -> Def(fst id, snd id, Public, Local, true, Some(scope_term md [] ty),
                     scope_term md [] te)}
  | KW_LOCAL KW_THM id=ID ps=param+ COLON ty=term DEF te=term DOT
    {fun md -> Def(fst id, snd id, Public, Local, true, Some(scope_term md [] (mk_pi ty ps)),
                     scope_term md [] (mk_lam te ps))}
