...
(* OASIS_START *)
(* DO NOT EDIT (digest: 846cffc5bb47cb1ab77ddcb99d0bb17b) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules =
                        ["Scoping"; "Builtins"; "Preterm"; "Tokens"];
                      lib_findlib_parent = Some "dedukti";
                      lib_findlib_name = None;
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "skcheck.ml"});
               Executable
                 ({
                     cs_name = "skdep";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "skdep.ml"});
               Executable
                 ({
                     cs_name = "sktop";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "sktop.ml"});
               Executable
                 ({
                     cs_name = "skindent";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "skindent.ml"});
               Test
                 ({
                     cs_name = "main";
                     cs_data = PropList.Data.create ();
     ...
     oasis_digest = Some "\237\158{C\170\000\147_\021\187\t)=L\206\232";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
