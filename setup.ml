...
(* OASIS_START *)
(* DO NOT EDIT (digest: cda193e6d2b63619cf8080c9b513b227) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "dkmeta.ml"});
               Doc
                 ({
                     cs_name = "api-kernel";
                     cs_data = PropList.Data.create ();
     ...
     oasis_digest = Some "Q\025\184Wc\127l\153L\194/\2559\024\241\144";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
