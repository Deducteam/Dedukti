...
(* OASIS_START *)
(* DO NOT EDIT (digest: 57db625402e9ac3e196e1460f3f19939) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = ["Typing"; "Dtree"; "Subst"; "Matching"; "Ac"];
     ...
     oasis_digest =
       Some "\023\208\192\222\196\171\005\210q4\017\017\169\210p\251";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
