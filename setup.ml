...
(* OASIS_START *)
(* DO NOT EDIT (digest: ac8734ef7391b2390e8e7d31d5fc9056) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./tests/tests.sh", []))];
     ...
     package =
       {
          oasis_version = "0.4";
          ocaml_version = Some (OASISVersion.VGreaterEqual "4.2.0");
          version = "2.5.1";
          license =
            OASISLicense.DEP5License
              (OASISLicense.DEP5Unit
                 {
                    OASISLicense.license = "CeCILL-B";
                    excption = None;
          ...
          copyrights = [];
          maintainers =
            ["Fran\195\167ois Thir\195\169 <dedukti-dev@inria.fr>"];
          authors = ["Ronan Saillard"];
          homepage = Some "http://dedukti.gforge.inria.fr/";
          bugreports = None;
          synopsis =
          ...
          description =
            Some
              [
                 OASISText.Para
                   "Dedukti is an implementation of the \\lambda\\Pi-calculus modulo theory"
              ];
          tags = [];
          categories = [];
          files_ab = ["kernel/version.ml.ab"];
          sections =
            [
               Library
                 ({
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "parser";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "kernel"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {
                      lib_modules = ["Parser"; "Lexer"];
                      lib_pack = false;
                      lib_internal_modules = ["Scoping"; "Preterm"; "Tokens"];
                      lib_findlib_parent = Some "dedukti";
                      lib_findlib_name = None;
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "kernel"; InternalLibrary "parser"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "dkcheck.ml"});
               Executable
                 ({
                     cs_name = "dkdep";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "dkdep.ml"});
               Executable
                 ({
                     cs_name = "dktop";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "dktop.ml"});
               Executable
                 ({
                     cs_name = "dkindent";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "dkindent.ml"});
               Executable
                 ({
                     cs_name = "universo";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "universo.ml"});
               Test
                 ({
                     cs_name = "main";
                     cs_data = PropList.Data.create ();
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$htmldir/kernel";
                      doc_title = "API reference for Dedukti kernel";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_digest = Some "\bC\024\026Y\134\151e\208\2224\020\249\016\021\210";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
