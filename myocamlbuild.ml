(* OASIS_START *)
(* DO NOT EDIT (digest: 446b3242281647a0932cac1cfd9c76ea) *)
...
let package_default =
  {
     ...
     includes =
       [
          ("universo", ["kernel"; "parser"]);
          ("parser", ["kernel"]);
          ("kernel/unionfind", ["kernel"]);
          ("kernel", ["kernel/unionfind"]);
          ("dktop", ["kernel"; "parser"]);
          ("dkindent", ["kernel"; "parser"]);
          ("dkdep", ["kernel"; "parser"]);
          ("dkcheck", ["kernel"; "parser"])
       ]
  }
  ;;
