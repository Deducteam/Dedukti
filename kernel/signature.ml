...
(*     Print.fail lc "Fail to open\ module '%s' (file generated by a different version?)." m *)
  | UnmarshalBadVersionNumber of loc*string
(*  Print.fail lc "Fail to open module '%s' (%s)." m s *)
  | UnmarshalSysError of loc*string*string
(*  Print.fail lc "Fail to open module '%s'." m *)
...
(*   Print.fail r.l "Cannot add rewrite\ rules for the defined symbol '%a'." pp_ident r.id *)
