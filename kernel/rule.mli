...
type pattern =
  (** l x i [x1 ; x2 ; ... ; xn] where [i] is the position of x inside the context of the rule *)
...
(** a wf_pattern is a Miller pattern without brackets constraints. *)
type wf_pattern =
  | LJoker
...
(** Check_patterns [i] [ps] checks that if the list of patterns [ps]
 * with a context of size [i] are Miller's pattern.
