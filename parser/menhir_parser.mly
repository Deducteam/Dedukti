...
line:
  ...
  | KW_DEF id=ID COLON ty=term DOT
      {fun md -> Decl(fst id, snd id, Definable Term.Free, scope_term md [] ty)}
  ...
  | KW_DEFAC id=ID LEFTSQU ty=term RIGHTSQU DOT
      {fun md -> Decl(fst id, snd id, Definable Term.AC, scope_term md [] ty)}

  | KW_DEFACU id=ID LEFTSQU ty=term COMMA neu=term RIGHTSQU DOT
      {fun md -> Decl(fst id, snd id, Definable(Term.ACU(scope_term md [] neu)),
	  scope_term md [] ty)}
